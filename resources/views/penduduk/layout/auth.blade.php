    ...
    <nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/penduduk') }}">
                    {{ config('app.name', 'Laravel Multi Auth Guard') }}: Penduduk
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('/penduduk/login') }}">Login</a></li>
                        <li><a href="{{ url('/penduduk/register') }}">Register</a></li>
                    @else
                        <li class="dropdown">
